package com.oldgamerdad.tutorial.world.gen;

import com.oldgamerdad.tutorial.Tutorial;
import com.oldgamerdad.tutorial.util.RegistryHandler;
    ...
    public static void generateOres(FMLLoadCompleteEvent event) {
        ...
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (biome.getCategory() == Biome.Category.NETHER) {
                ...
                genOre(biome, 10, 5, 5, 80, OreFeatureConfig.FillerBlockType.NETHERRACK, RegistryHandler.RUBY_ORE.get().getDefaultState(), 4);

            // The End Ore Gen
            } else if (biome.getCategory() == Biome.Category.THEEND) {

                genOre(biome, 8, 3, 5, 80, END_STONE, RegistryHandler.RUBY_ORE.get().getDefaultState(), 12);

            // The Overworld Ore Gen
            } else {
